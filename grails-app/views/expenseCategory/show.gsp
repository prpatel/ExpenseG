...
<html>
    <head>
        ...
        <title>Show ExpenseCategory</title>
    </head>
    <body>
        <div class="nav">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:expenseCategory, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:expenseCategory, field:'name')}</td>
